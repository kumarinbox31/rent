...
<link rel="icon" href="<?php echo base_url('theme/'); ?>assets/images/logo.svg">
...
<nav class="navbar">
    <div class="col-12">        
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/"><img src="<?php echo base_url('theme/'); ?>assets/images/logo.svg" width="30" alt="Compass"><span class="m-l-10">Rental</span></a>
        </div>
...
<!-- Left Sidebar -->
<?php include 'type/'.strtolower($this->session->type).'.php'; ?>
                    ...
                    <ul class="list-unstyled">
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar4.jpg" alt="">
                        ...
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar5.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li class="offline">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar2.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li class="me">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar1.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar3.jpg" alt="">
                                    <div class="media-body">
                ...
                <div class="card">
                    ...
                    <ul class="list-unstyled">
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar10.jpg" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar6.jpg" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar7.jpg" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar8.jpg" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar9.jpg" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="progress-container progress-primary">
                        ...
                        <ul class="list-unstyled team-info">
                            ...
                            <li>
                                <img src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar2.jpg" alt="Avatar">
                            </li>
                            <li>
                                <img src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar3.jpg" alt="Avatar">
                            </li>
                            <li>
                                <img src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar4.jpg" alt="Avatar">
                            </li>                            
                        </ul>
                    </div>
                    <div class="progress-container">
                        ...
                        <ul class="list-unstyled team-info">
                            <li class="m-r-15"><small>Team</small></li>
                            <li>
                                <img src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar10.jpg" alt="Avatar">
                            </li>
                            <li>
                                <img src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar9.jpg" alt="Avatar">
                            </li>
                            <li>
                                <img src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar8.jpg" alt="Avatar">
                            </li>
                            <li>
                                <img src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar7.jpg" alt="Avatar">
                            </li>
                            <li>
                                <img src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar6.jpg" alt="Avatar">
                            </li>
                        </ul>
                    </div>
                    <div class="progress-container progress-warning">
                        ...
                        <ul class="list-unstyled team-info">
                            <li class="m-r-15"><small>Team</small></li>
                            <li>
                                <img src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar5.jpg" alt="Avatar">
                            </li>
                            <li>
                                <img src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar2.jpg" alt="Avatar">
                            </li>
        ...
        <div class="body">
            ...
            <ul class="chat-scroll-list clearfix">
                <li class="left float-left">
                    <img src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar3.jpg" class="rounded-circle" alt="">
                    <div class="chat-info">
                ...
                <li class="left float-left"> <img src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar2.jpg" class="rounded-circle" alt="">
                ...
                <li class="left float-left"> <img src="<?php echo base_url('theme/'); ?>assets/images/xs/avatar1.jpg" class="rounded-circle" alt="">
